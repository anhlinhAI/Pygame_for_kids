...
def reset_dancer():
    ...
    return
'''
tạo hàm reset_dancer:
    khai báo biến game_over
    nếu game chưa thua:
        cập nhật hình ảnh dancer thành "dancer-start"
        cập nhật hình ảnh up thành "up"
        cập nhật hình ảnh down thành "down"
        cập nhật hình ảnh right thành "right"
        cập nhật hình ảnh left thành "left"
'''
