...
'''
tạo hàm check_flower_collision:
    khai báo biến cow, flower_list,wilted_list
    tạo biến i = 0
    tạo vòng lặp for duyệt qua từng flower trong flower_list:
        #nếu flower chạm cow và hình ảnh của flower là 'flower-wilt' thì
        if flower.colliderect(cow) and flower.image == 'flower-wilt':
            #đổi hình ảnh của flower thành 'flower'
            flower.image = 'flower'
            #đổi biến của danh sách wilted_list tại i bằng 'happy'
            wilted_list[i] = 'happy'
            break 
        tăng i lên 1 đơn vị
'''
...
'''
tạo hàm check_fangflower_collision:
    khai báo biến cow, fangflower_list, fangflower_collision, game_over
    tạo vòng lặp for duyệt qua từng fangflower trong fangflower_list:
        nếu fangflower chạm cow:
            đổi hình ảnh của cow thành "zap"
            đổi game_over thành True 
            break 
'''
